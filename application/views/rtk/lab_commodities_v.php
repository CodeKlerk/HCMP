...
<tr>					
						<td colspan = "14" style = "text-align:left">Explain Losses and Adjustments</td>
					</tr>
<tr>					
...
<input class="button" type="submit"   id="save1"  value="Save" style="margin-left: 0%; width=100px" >
